...
import { Store, Clock, CreditCard, Bell, Save, Loader2, MapPin, Globe, Key, RefreshCw, Check, AlertCircle, ExternalLink } from "lucide-react";
        ...
        <div className="p-4 bg-gray-50 rounded-xl">
          <div className="flex items-start justify-between mb-4">
            <div>
              ...
              <p className="text-sm text-gray-500">
                Untuk konversi mata uang real-time
              </p>
            </div>
            <a 
          ...
          <div className="mb-4 p-3 rounded-lg bg-white border border-gray-200">
            ...
            {settings.exchangerate_api_key_preview && (
              <p className="text-xs text-gray-500">
                Key: {settings.exchangerate_api_key_preview}
              </p>
            )}
            {currencyInfo && (
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex items-center gap-2 rounded-xl bg-amber-600 px-4 py-2 text-white hover:bg-amber-700 disabled:opacity-50"
              >
              ...
              {settings.exchangerate_api_key_configured && (
                <button
                  ...
                  className="flex items-center gap-2 rounded-xl border border-gray-200 bg-white px-4 py-2 text-gray-700 hover:bg-gray-50 disabled:opacity-50"
                >
...
// Export types
export type { StoreSettings, OperationalSettings, PaymentSettings, SocialSettings, ApiKeysSettings, CurrencyInfo };
